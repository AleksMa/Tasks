<p>Пусть ℕ<sub>32</sub> – множество натуральных чисел от 0 до 31. Даны два множества A ⊆ ℕ<sub>32</sub> и B ⊆ ℕ<sub>32</sub>. Составьте программу intersect.c, вычисляющую пересечение множеств A и B.<br>
